...
const GLOBAL_CONFIG_NAME = '_bk'
const COMPONENT_PREFIX = 'B'
export interface BkUIOptions {
  classPrefix?: string
...
export const setGlobalConfig = (
  app: App,
  options: BkUIOptions = { classPrefix: CLASS_PREFIX }
) => {
...
// 获取组件name的prefix
export const getComponentPrefix = (options?: BkUIOptions): string =>
